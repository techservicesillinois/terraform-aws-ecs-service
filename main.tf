...
resource "aws_ecs_service" "awsvpc_all" {
  ...
  service_registries {
    registry_arn = element(
      concat(
        aws_service_discovery_service.default.*.arn,
        aws_service_discovery_service.health_check.*.arn,
        aws_service_discovery_service.health_check_custom.*.arn,
        aws_service_discovery_service.health_check_and_health_check_custom.*.arn,
      ),
      0,
    )
  }
